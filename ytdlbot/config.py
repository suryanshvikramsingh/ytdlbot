...
APP_ID: "int" = int(os.getenv("APP_ID", 10785700))
APP_HASH = os.getenv("APP_HASH", "04a4924d21afcd9d27495f664a668f39")
TOKEN = os.getenv("TOKEN", "5652986005:AAEyrqflgqMQPA1RrEVlyR9GRfLFOlKuBUo")
